...
public class WineBarMainActivity extends Activity {
    ...
    public static final String DB_GET_LIST = DBConnect.DB_HOST
	    + "/winebar/get_wine_list.php";
    public static final String DB_WINE_TYPE = DBConnect.DB_HOST
	    + "/winebar/sort_by_type.php";
	...
	try {
		...
		public void onItemClick(AdapterView<?> parent, View view,
		    ...
		    String val_description = listOfWines.get(position)
			    .getDescription();
		    String val_image = listOfWines.get(position).getImage();
		    String val_w_id = listOfWines.get(position).getW_id();

		    Intent wineProfileIntent = new Intent(
			    WineBarMainActivity.this, WineProfile.class);
	    ...
	    Toast.makeText(getApplicationContext(),
		    "WineBar needs networking to serve you...",
	...
	try {
	    ...
	    wineList.setAdapter(new ArrayAdapter<String>(this,
		    android.R.layout.simple_list_item_1, names));
	} catch (Exception e) {
	    Toast.makeText(getApplicationContext(),
		    "WineBar needs networking to serve you...",
